...
assert.match(legacyShell.appended[0].src, /^js\/main\.js\?v=.+/, 'legacy recovery uses a versioned main module URL');
...
assert.match(index, /js\/main\.js\?v=/, 'current shell loads a versioned main module URL');
assert.doesNotMatch(index, /<script type="module" src="js\/main\.js"><\/script>/, 'unversioned static module boot is removed');
