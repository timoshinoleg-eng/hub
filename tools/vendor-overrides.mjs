...
for(const [src,dst] of [
  ...
  ['snake-index.html','games/snake/index.html'],['snake-style.css','games/snake/style.css'],
  ['echo-style.css','games/echo/style.css'],['memory-style.css','games/memory/style.css'],
])copy(src,dst);
