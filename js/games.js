...
{id:'quiz',title:'Квизик',tagline:'Большой квиз: темы, XP, рейтинг и дуэли',icon:'quiz',enabled:true,unit:'очков',genre:'ЭРУДИЦИЯ',length:'2–5 мин',accent:'#4d96ff',accent2:'#4ce3e8',howTo:'Открой полноценный Квизик: быстрые раунды, квиз дня, рейтинг и дуэли с друзьями.',hint:'tap',modulePath:'/quiz/',cfg:themed({preventScroll:true})},
