...
export const GAMES = [
  {
    id:'merge',title:'Мердж 2048',tagline:'Соединяй плитки и строй комбо',emoji:'🔢',icon:'assets/game-icons/merge.svg',enabled:true,unit:'очков',
  ...
  {
    id:'reaction',title:'Реакция',tagline:'30 секунд чистого рефлекса',emoji:'⚡',icon:'assets/game-icons/reaction.svg',enabled:true,unit:'попаданий',
  ...
  {
    id:'snake',title:'Змейка',tagline:'Собирай еду и не врежься',emoji:'🐍',icon:'assets/game-icons/snake.svg',enabled:true,unit:'очков',
    genre:'АРКАДА',length:'1–3 мин',accent:'#57da84',accent2:'#28c9b7',
    howTo:'Свайпай в нужную сторону. Не разворачивайся прямо в себя.',
    cfg:{scoreSelector:'.score',preventScroll:true},
  },
  {
    id:'sapper',title:'Сапёр',tagline:'Один расклад на всех сегодня',emoji:'💣',icon:'assets/game-icons/sapper.svg',enabled:true,unit:'очков',
  ...
  {
    id:'quiz',title:'Квиз дня',tagline:'10 быстрых вопросов на эрудицию',emoji:'❓',icon:'assets/game-icons/quiz.svg',enabled:true,unit:'правильных',
  ...
  {
    id:'echo',title:'Эхо',tagline:'Запомни и повтори ритм',emoji:'🔔',icon:'assets/game-icons/echo.svg',enabled:true,unit:'уровней',
  ...
  {
    id:'memory',title:'Пары',tagline:'Найди 8 пар за минимум ходов',emoji:'🧠',icon:'assets/game-icons/memory.svg',enabled:true,unit:'ходов',
